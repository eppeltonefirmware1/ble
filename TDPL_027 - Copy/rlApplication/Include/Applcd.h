...
#define	MSG_DNLD_INDEX		0xD0
#define	MSG_RTCBAT_STATUS	0x90
#define	MSG_PROD_STATUS		0xFE
#define MSG_LOCK_INDEX		0xFB
#define MSG_UNLOCK_INDEX	0xFC
...
#define BILL_TOD_KVAH_START_INDEX	0xC0
#define BILL_TOD_KVAH_END_INDEX		0xC7
...
#define RAM_EXPKWH		(uint8_t *)0
#define RAM_EXPKVAH		(uint8_t *)0
...
#define RAM_TEMP 		(uint8_t *)&InsTemp
#define RAM_GFRQ 		(uint8_t *)&gblFrq
#define RAM_GWAV 		(uint8_t *)&gblWave
...
#define MSG_ESD		(uint8_t *)&TamperRecord.TamperCount[10]

#define MSG_STATUS	(uint8_t *)&TamperRecord.TamperStatusFlag
#define MSG_FORMFACTOR (uint8_t *)&formfactor
...
#define MSG_LOCK		(uint8_t *)0
#define MSG_UNLOCK		(uint8_t *)0
#define MSG_OK			(uint8_t *)0
...
#define TOD_kVAh1		(uint8_t *)&InsSave.TODEnergy.TOD[0].kVAh
#define TOD_kVAh2		(uint8_t *)&InsSave.TODEnergy.TOD[1].kVAh
#define TOD_kVAh3		(uint8_t *)&InsSave.TODEnergy.TOD[2].kVAh
#define TOD_kVAh4		(uint8_t *)&InsSave.TODEnergy.TOD[3].kVAh
#define TOD_kVAh5		(uint8_t *)&InsSave.TODEnergy.TOD[4].kVAh
#define TOD_kVAh6		(uint8_t *)&InsSave.TODEnergy.TOD[5].kVAh
#define TOD_kVAh7		(uint8_t *)&InsSave.TODEnergy.TOD[6].kVAh
#define TOD_kVAh8		(uint8_t *)&InsSave.TODEnergy.TOD[7].kVAh
...
#define CHR_G   (SEGA_BIT|SEGC_BIT|SEGD_BIT|SEGE_BIT|SEGF_BIT)
