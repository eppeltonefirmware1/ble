...
#define WAVE_DETECT			P7
#define WAVE_DETECT_DIR		PM7
#define WAVE_DETECT_BIT		BIT4


#define MAG_VCC			P7
#define MAG_VCC_DIR		PM7
#define MAG_VCC_BIT		BIT3
#define MAG_VCC_SET_OFF	0
#define MAG_VCC_SET_ON	1
...
#define GET_JAM_STATUS			(ESD&ESD_BIT?1:0)
#define GET_WAVE_STATUS			(WAVE_DETECT&WAVE_DETECT_BIT?1:0)
#define GET_ESD_STATUS			((GET_WAVE_STATUS)|(GET_JAM_STATUS)?1:0)
...
//#define IS_PRODUCTION_MODE		(1)
//#define RTC_IS_THERE			(RTC_VDD&RTC_VDD_BIT?0:1)
#define GET_BLE_STATUS			(PRODUCTON_MODE_STATUS)
#define SET_MAG_ON_VCC			{MAG_VCC|=MAG_VCC_BIT;}
#define SET_MAG_OFF_VCC			{MAG_VCC&=~MAG_VCC_BIT;}
#define SET_EEP_ON_VCC			{RTC_OUT|=RTC_OUT_BIT;}
#define SET_EEP_OFF_VCC			{RTC_OUT&=~RTC_OUT_BIT;}

#define GET_MAG_VCC_STATUS		(MAG_VCC&MAG_VCC_BIT?1:0)
