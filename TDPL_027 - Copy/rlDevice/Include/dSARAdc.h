...
#define _9D_AD_INPUT_TEMPERSENSOR                   (0x1DU) /* temperature sensor output is used to be the input channel */
...
void init_32ClockFrq(void);
void get32kClockFrq(void);
void stop32ClockFrq(void);
