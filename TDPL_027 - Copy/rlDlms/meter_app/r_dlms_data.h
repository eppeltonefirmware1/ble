...
typedef struct tag_class07_blockload_entry_t
{
	...
	Integer32	phC_value;		/* ph current */
	Integer32	NuC_value;		/* nu current */
	Integer32	pf;				/* avg. power factor*/
	Integer32	kWh_value;		/* Block Energy – kWh  */
	Integer32	kVAh_value;		/* Block Energy – kVAh */
	Integer32	kW_value;		/* Block Energy – kW */
	Integer32	kVA_value;		/* Block Energy – kVA */
	Integer32	AvgI_value;		/* effective current */
	Integer32	AvgTem;			/* avg temerature */
...
typedef struct tag_class07_dailyload_entry_t
{
	...
	Integer32	H1kW_value;		/* H1 kW */
	Integer32	H1kVA_value;		/* H1 kVA */
	Integer32	daykW_value;		/* H1 kW */
	Integer32	daykVA_value;		/* H1 kVA */
