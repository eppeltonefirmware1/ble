...
#define EM_CUCUMLARIVE_POWER_OFF_DURATION	(0x83)
#define EM_TEMPERATURE						(0x84)
#define EM_POWERFAIL_COUNT					(0x85)
...
#define EM_BLOCK_AVG_PHCURENT				(0x67)
#define EM_BLOCK_AVG_NUCURENT				(0x68)
#define EM_BLOCK_AVG_APP_LOAD				(0x69)
