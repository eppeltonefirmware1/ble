...
const class01_child_record_t g_ChildTableClass01[] =
{
	...
	//meter constant
	/* 23 */ {	{   1,   0,  0,   3, 0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_OCTET_STRING(-1), NULL, ATTR_ACCESS_USERFUNC		)	},
	//volatge ratings
	/* 24 */ {	{   0,   0,  94,   91, 15, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_OCTET_STRING(-1), NULL, ATTR_ACCESS_USERFUNC	)	}
};
...
const class03_child_record_t g_ChildTableClass03[] =
{
	...
	/* 40 */ {	{   1,   0,  11,   27,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_VOLTAGE	, PHY_UNIT_AMPERE			}	},	/* Avg block Ph Current  */
	/* 41 */ {	{   1,   0,  91,   27,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_VOLTAGE	, PHY_UNIT_AMPERE			}	},	/* Avg block Neu Current  */
	/* 42 */ {	{   1,   0,   9,   27,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_MD	, PHY_UNIT_WATT					}	},	/* block apparent Power   */
	/* 43 */ {	{   0,	0,	 94,	91,	8,	255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_NULL	,PHY_UNIT_MIN					}	},	/* Cumulative power Off duration in minutes */
	/* 44 */ {	{   0,   0,  96,   9,   129, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_VOLTAGE	, PHY_UNIT_DEGREE_CELSIUS	}	},	/* temperature  */
	/* 45 */ {	{   0,   0,  96,   7,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_NULL	, PHY_UNIT_NONE				}	}	/* powerfail counter */
...
const class07_capture_object_t g_Class07_InstCaptureObjects[] =
{
	...
	/* 18 */ {	{   1,   0,  96,   5,   0, 255 }, 1			, 2			, 0		},	/* Selft diagnostic*/
	/* 19 */ {	{   0,   0,  96,   50,  9, 255 }, 3			, 2			, 0		},	/* bill day*/
	/* 20 */ {	{   0,	0,	 94,	91,	8,	255 }, 3		, 2			, 0		},	/* Power off duration*/
	/* 21 */ {	{   0,   0,  96,   9,   129, 255 }, 3		, 2			, 0		}	/* temperature*/
	
};
const Unsigned16 	g_Class07_InstCaptureObjectsLength = sizeof(g_Class07_InstCaptureObjects) / sizeof(class07_capture_object_t);
const Unsigned8 PARA_RAM_SIZE_INSTANT[]={12,4,4,4,4,4,4,4,4,4,4,12,4,12,4,4,4,4,4,4,4,4};
...
const class07_capture_object_t g_Class07_InstCaptureObjects_Scaler[] =
{
	...
	/* 16 */ //{	{   0,   0,   0,   1,   0, 255 }, 1			, 2			, 0		},	/* Cumulative billing count */
	/* 17 */ //{	{   0,   0,  96,   2,   0, 255 }, 1			, 2			, 0		},	/* Cumulative programming count */
	/* 18 */ //{	{   1,   0,  96,   5,   0, 255 }, 1			, 3			, 0		},	/* Selft diagnostic*/
	/* 19 */ //{	{   0,   0,  96,   50,  9, 255 }, 3			, 3			, 0		},	/* bill day*/
	/* 20 */{	{   0,	0,	 94,	91,	8,	255 }, 3			, 3			, 0		},/* power off duration*/
	/* 21 */{	{   0,   0,  96,   9,   129, 255 }, 3			, 3			, 0		} //temperature 
...
const class07_capture_object_t g_Class07_BlockloadCaptureObjects[] =
{
	...
	/* 02 */ {	{   1,   0,  11,   27,   0, 255 }, 3		, 2			, 0		},	/* Avg Block ph Current*/
	/* 03 */ {	{   1,   0,  91,   27,   0, 255 }, 3		, 2			, 0		},	/* Avg Block Nu Current*/
	/* 04 */ {	{   1,   0,  13,   27,   0, 255 }, 3		, 2			, 0		},	/* Avg block PF*/
	/* 05 */ {	{   1,   0,  1,    29,   0, 255 }, 3		, 2			, 0		},	/* Block Energy – kWh  */
	/* 06 */ {	{   1,   0,   9,   29,   0, 255 }, 3		, 2			, 0		},	/* Block Energy – kVAh  */
	/* 07 */ {	{   1,   0,   1,   27,   0, 255 }, 3		, 2			, 0		},	/* Block kW  */
	/* 08 */ {	{   1,   0,   9,   27,   0, 255 }, 3		, 2			, 0		},	/* Block kVA  */
	/* 09 */ {	{   1,   0,  94,  91,  	14, 255 }, 3		, 2			, 0		},	/* Effective Current  */
	/* 10 */{	{   0,   0,  96,   9,   129, 255 }, 3		, 2			, 0		} //temperature
...
const Unsigned8 PARA_RAM_SIZE_BLOCKLOAD[]={12,4,4,4,4,4,4,4,4,4,4};
...
const class07_capture_object_t g_Class07_BlockloadCaptureObjects_Scaler[] =
{
	...
	/* 02 */ {	{   1,   0,  11,   27,   0, 255 }	, 3			, 3			, 0		},	/* Avg Block ph Current*/
	/* 03 */ {	{   1,   0,  91,   27,   0, 255 }	, 3			, 3			, 0		},	/* Avg Block Nu Current*/
	/* 04 */ {	{   1,   0,  13,   27,   0, 255 }	, 3			, 3			, 0		},	/* Avg block PF*/
	/* 05 */ {	{   1,   0,  1,    29,   0, 255 }	, 3			, 3			, 0		},	/* Block Energy – kWh  */
	/* 06 */ {	{   1,   0,   9,   29,   0, 255 }	, 3			, 3			, 0		},	/* Block Energy – kVAh  */
	/* 07 */ {	{   1,   0,   1,   27,   0, 255 }	, 3			, 3			, 0		},	/* Block kW  */
	/* 08 */ {	{   1,   0,   9,   27,   0, 255 }	, 3			, 3			, 0		},	/* Block kVA  */
	/* 09 */ {	{   1,   0,  94,  91,  	14, 255 }	, 3			, 3			, 0		},	/* Effective Current  */
	/* 21 */{	{   0,   0,  96,   9,   129, 255 }, 3			, 3			, 0		} //temperature
};
...
const class07_capture_object_t g_Class07_DailyloadCaptureObjects[] =
{
	...
	/* 03 */ {	{   1,   0,   1,   6,   0, 255 }, 4			, 2			, 0		},	/* H1 kW MD */
	/* 04 */ {	{   1,   0,   9,   6,   0, 255 }, 4			, 2			, 0		},	/* H1 kVA MD */
	/* 05 */ {	{   1,   0,   1,   6,   1, 255 }, 4			, 2			, 0		},	/* day kW MD */
	/* 06 */ {	{   1,   0,   9,   6,   1, 255 }, 4			, 2			, 0		},	/* day kVA MD */
...
const Unsigned8 PARA_RAM_SIZE_DAILYLOAD[]={12,4,4,4,4,4,4};
/* Capture object list Scaler */
const class07_capture_object_t g_Class07_DailyloadCaptureObjects_Scaler[] =
{
	...
	/* 03 */ {	{   1,   0,   1,   6,   0, 255 }, 4			, 3			, 0		},	/* H1 kW MD */
	/* 04 */ {	{   1,   0,   9,   6,   0, 255 }, 4			, 3			, 0		},	/* H1 kVA MD */
	/* 05 */ {	{   1,   0,   1,   6,   1, 255 }, 4			, 3			, 0		},	/* day kW MD */
	/* 06 */ {	{   1,   0,   9,   6,   1, 255 }, 4			, 3			, 0		},	/* day kVA MD */
...
const class07_capture_object_t g_Class07_Event0CaptureObjects[] =
{
	...
	/* 02 */ {	{   1,   0,  91,   7,   0, 255 }, 3			, 2			, 0		},	/* Nu Current  */
...
const class07_capture_object_t g_Class07_Event0CaptureObjects_Scaler[] =
{
	...
	/* 02 */ {	{   1,   0,  91,   7,    0, 255 }, 3			, 3			, 0		},	/* Nu Current  */
...
// Check again CLASS07_EVENT_MAX_PROFILE
 Unsigned32	g_Class07_Event_MaxEntries[8] ;/*= {	CLASS07_EVENT_MAX_ENTRY,
...
const class07_capture_object_t g_Class07_NamePlateCaptureObjects[] =
{
	...
	/* 07 */ {	{   1,   0,  0,   3, 0, 255    }, 1			, 2			, 0		},	/* meter constant */
	/* 08 */ {	{   0,   0,  94,   91, 15, 255 }, 1			, 2			, 0		},	/* voltage ratings */
};
