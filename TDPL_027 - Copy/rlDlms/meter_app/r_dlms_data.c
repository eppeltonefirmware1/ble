...
const scaler_unit_t		g_Class07_InstScalerBuffer[] =
{
	...
	{SCALAR_NULL, PHY_UNIT_NONE				},	/* self diagnostic */
	{SCALAR_NULL, PHY_UNIT_NONE				},	/* bill day*/
	{SCALAR_NULL, PHY_UNIT_MIN				},	/* Cumulative power Off duration in minutes */
	{SCALAR_VOLTAGE, PHY_UNIT_DEGREE_CELSIUS	}	/* degree celsius */
...
const scaler_unit_t		g_Class07_BlockloadScalerBuffer[] =
{
	...
	{SCALAR_LS_A, PHY_UNIT_AMPERE			},	/* Block Avg Current */
	{SCALAR_LS_A, PHY_UNIT_AMPERE			},	/* Block Avg Current */
	{SCALAR_PF, PHY_UNIT_NONE					},	/* Block pf */
	{SCALAR_LS_WH, PHY_UNIT_WATT_HOUR			},	/* Block Energy – kWh */
	{SCALAR_LS_VAH, PHY_UNIT_VOLT_AMPERE_HOUR	},	/* Block Energy - kVAh*/
	{SCALAR_LS_WATT, PHY_UNIT_WATT				},	/* Avg kW Load */
	{SCALAR_LS_VA, PHY_UNIT_VOLT_AMPERE		},	/* Avg kVA Load */
	{SCALAR_LS_A, PHY_UNIT_AMPERE			},	/* Block Avg Effective Current */
	{SCALAR_CON, PHY_UNIT_DEGREE_CELSIUS			},	/* Block Avg Temp */
		...
		if (attr_id == 2)
		{
			...
			switch (child_id)
			{
				...
				case 22:	/* Download complete status */
					...
					pbuffer = (Unsigned8 *)&u16;
					break;
				case 23:	/* meter constant */
					size =  R_USER_GetNamePlate(EM_NAME_PLATE_METER_CONSTANT, pbuffer);
					if (size < 0)
					{
						return 0;
					}
					break;
				case 24:	/* volatge rating */
					size =  R_USER_GetNamePlate(EM_NAME_PLATE_VOLAGE_RATING, pbuffer);
					if (size < 0)
					{
						return 0;
					}
...
//			Unsigned16 u16;
			...
			switch (child_id)
			{
				...
				case 39:
					...
					break;
				case 40:
					temp_f32 = R_USER_GetEMData(EM_BLOCK_AVG_PHCURENT);
					pbuffer = &temp_f32;
					break;
				case 41:
					temp_f32 = R_USER_GetEMData(EM_BLOCK_AVG_NUCURENT);
					pbuffer = &temp_f32;
					break;
				case 42:
					temp_f32 = R_USER_GetEMData(EM_BLOCK_AVG_APP_LOAD);
					pbuffer = &temp_f32;
					break;
				case 43:
					temp_f32 = R_USER_GetEMData(EM_CUCUMLARIVE_POWER_OFF_DURATION);
					pbuffer = &temp_f32;
					break;
				case 44:
					temp_f32 = R_USER_GetEMData(EM_TEMPERATURE);
					pbuffer = &temp_f32;
					break;
				case 45:
					temp_f32 = R_USER_GetEMData(EM_POWERFAIL_COUNT);
					pbuffer = &temp_f32;
					break;
